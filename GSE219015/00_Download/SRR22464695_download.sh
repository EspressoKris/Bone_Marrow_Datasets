#!/bin/bash
#SBATCH --job-name=SRR22464695_download
...
output_dir="/path/to/data/GSE219015_Healthy_BMMNCs_and_CD34_enriched_BMMNCs_scMultiome/Data/Raw_Data/BMMNC_Aged_HD02/Unfractionated_BMMNC_Multiome/ATAC"
