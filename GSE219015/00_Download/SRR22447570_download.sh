#!/bin/bash
#SBATCH --job-name=SRR22447570_download
...
output_dir="/path/to/data/GSE219015_Healthy_BMMNCs_and_CD34_enriched_BMMNCs_scMultiome/Data/Raw_Data/BMMNC_Aged_HD01/CD34_Enriched_Multiome/RNA"
